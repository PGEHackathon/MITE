...
|  | 7:30 AM - 9:30 PM | Data Science in Python | Python packages NumPy, SciPy, matplotlib, etc. | [e-book](https://johnfoster.pge.utexas.edu/numerical-methods-book/)  | [Well Plotting](problem/maps.ipynb)|  | [Scientific Python](https://www.youtube.com/watch?v=jSNs4I4abKg&list=PLCnlJOMhMC0PW7IUv312SgQauEujq1HdU) | 
